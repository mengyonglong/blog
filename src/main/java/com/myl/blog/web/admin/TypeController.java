package com.myl.blog.web.admin;

import com.myl.blog.po.Type;
import com.myl.blog.service.TypeService;
...
public class TypeController {
    ...
    public String post(@Valid Type type, BindingResult result, RedirectAttributes attributes) {
        ...
        if (type1 != null) {
            result.rejectValue("name","nameError","不能添加重复的分类哦");
        }
        if (result.hasErrors()) {
            return "admin/types-input";
        }
        ...
        if (t == null ) {
            attributes.addFlashAttribute("message", "新增失败呢");
        } else {
    ...
    public String editPost(@Valid Type type, BindingResult result,@PathVariable Long id, RedirectAttributes attributes) {
        ...
        if (t == null ) {
            attributes.addFlashAttribute("message", "更新失败呢");
        } else {
